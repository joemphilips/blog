...
マイニングに成功しても、報酬が即座に払われず1000ブロック後に払われるように記憶される。（なぜ？）
...
今まで紹介したコンセンサスプロトコルは、全て投票による合意(*consensus by bet*)の特殊例とみなすことができる。
...
CasperではPoWのように**チェーン**ごと（つまりブロックヘッダ）に投票するのではなく、
**ブロック**に対して投票する
