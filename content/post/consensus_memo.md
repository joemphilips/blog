...
Ethereumは[インサイダーが信用できない](https://www.cryptocoinsnews.com/source-ethereum-insiders-believe-dao-hack-inside-job/)という大きな問題があり、正直この点がアキレス腱になっていると思う。

### PoIの欠点

#### 1. トランザクショングラフがかけなくてはならないので、Fungibilityが絶対に手に入らない。

クリプトアナーキストにとっては我慢ならないとは思うが、大抵の人はそんなことは気にしないのでは。とは思う。
Fungibilityが問題となるのは大きく２点

1. トークン間に価値の差異が生まれてしまうのではないかという点

これは今のJPYやUSDでも同じであるし、気にする人はそんなに居ないので問題ないのではないかと思う。

2. 個人を識別できてしまう可能性がある点
